      ...
      <td class="txt_form">
        ...
        <?php
          ...
          if (isset($_POST['libro']) && !empty($_POST['libro']) && isset($_POST['capitulo']) && !empty($_POST['capitulo']) && isset($_POST['versiculo']) && !empty($_POST['versiculo'])) {
            ...
            echo '
		      ...
		      <form name="version_column" action="'.htmlspecialchars($_SERVER['REQUEST_URI']).'" method="post">
              <input type="hidden" name="libro" value="'.$libro.'" />
              <input type="hidden" name="capitulo" value="'.$capitulo.'" />
        ...
        <?php
          ...
          ########################### Determine if Paralelo was received
            ...
            echo '
			  <form name="version_right_column" action="'.htmlspecialchars($_SERVER['REQUEST_URI']).'" method="post">
          ...
          ########################### Determine if a Third Paralelo Column was received
            ...
            echo '
			  <form name="version_left_column" action="'.htmlspecialchars($_SERVER['REQUEST_URI']).'" method="post">
            ...
            echo '
			  <form name="version_third_column" action="'.htmlspecialchars($_SERVER['REQUEST_URI']).'" method="post">
